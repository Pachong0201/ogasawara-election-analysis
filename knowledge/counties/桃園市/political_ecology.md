...
## 当前地方关系（L3）
- ly11-office-桃園市-牛煦庭: 牛煦庭 → office_holding → 立法院第11屆立法委員；status=active_verified；current_use=current_usable；time_scope=2024-02-01—current
- ly11-office-桃園市-涂權吉: 涂權吉 → office_holding → 立法院第11屆立法委員；status=active_verified；current_use=current_usable；time_scope=2024-02-01—current
- ly11-office-桃園市-魯明哲: 魯明哲 → office_holding → 立法院第11屆立法委員；status=active_verified；current_use=current_usable；time_scope=2024-02-01—current
...
## 当前地方议题（L3）
- official-issue-20260926-3-0: 桃園市府9月9日答詢稱已提出國際暗空認證申請，仍依評鑑意見改善道路照明；此紀錄僅表示當日申請進度，尚不確認取得認證。；current_use=current_usable；date=2026-09-09；time_scope=2026-09-09
- official-issue-20260926-3-1: 李柏坊質詢大溪建設投入，捷工局答詢列綠線延伸大溪總經費約419.56億元；此處記錄公共建設經費議題與當日說法，不認定已核定支出。；current_use=current_usable；date=2026-09-09；time_scope=2026-09-09

## 人物—组织—地区关系索引
- 牛煦庭 → office_holding → 立法院第11屆立法委員；region=桃園市；current_use=current_usable
- 涂權吉 → office_holding → 立法院第11屆立法委員；region=桃園市；current_use=current_usable
- 魯明哲 → office_holding → 立法院第11屆立法委員；region=桃園市；current_use=current_usable
...
- 桃園市 当前与近二十年有哪些可由公开资料确认的关键地方政治人物，其公职与经营地区为何？（leads=0, verified=0）
- 桃園市 有哪些与地方政治相关、且能由公开资料确认的人物—组织关系？（leads=0, verified=0）
- 学术或可靠公开资料如何描述 桃園市 的历史派系或政治网络，其有效时间范围及当前可验证状态为何？（leads=0, verified=0）
- 桃園市 的行政区、立委选区与历届地方选举空间差异中，哪些结构需要结合边界版本解释？（leads=0, verified=0）
- 桃園市 有哪些地方社团与公共事务网络可由可靠资料确认，且不得据其存在推断政治支持？（leads=0, verified=0）
- 桃園市 农会、渔会的组织分布与公开政治互动有哪些可核实记录，其时间范围为何？（leads=0, verified=0）
- 桃園市 宗教组织参与地方公共事务或公开政治活动的可验证记录有哪些，证据边界为何？（leads=0, verified=0）
